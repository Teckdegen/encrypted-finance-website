      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 sm:flex-row">
        ...
        <div className="flex items-center gap-6">
          <a
            ...
            className="flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-foreground transition-colors hover:text-foreground/70"
          ...
          >
            ...
            <span className="hidden sm:inline">X.com</span>
          </a>
          <a
