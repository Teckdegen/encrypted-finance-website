    ...
    <section id="community" className="relative px-6 py-32">
      <div className="mx-auto max-w-4xl">
        <div className="flex flex-col gap-4">
          ...
          >
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-green-400/80">
              Find us on the feed
            </p>
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-mono text-white">X.com</span>
              <svg
                width="14"
                height="14"
                viewBox="0 0 14 14"
          ...
          >
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-orange-400/80">
              Join our community
            </p>
            <div className="flex items-center gap-2">
              <svg
              ...
              <span className="text-lg font-mono text-white">Telegram</span>
              <svg
                width="14"
                height="14"
                viewBox="0 0 14 14"
